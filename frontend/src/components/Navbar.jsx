  ...
  return (
    <div className="flex justify-between items-center px-3 sm:px-8 md:px-12 py-6 bg-gradient-to-r from-sky-300 via-sky-400 to-sky-200 shadow-md">
      ...
      {user ? (
        ...
        <div className="flex items-center gap-3 md:gap-6 text-base sm:text-lg">
          <Link to="/login">
          ...
          <Link to="/signup">
            <button className="cursor-pointer bg-sky-500 rounded-lg px-4 py-1 text-white hover:bg-sky-600 shadow transition">
              Sign up
            </button>
          </Link>
        </div>
