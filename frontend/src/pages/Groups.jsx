...
const Groups = () => {
  ...
  return (
    <div className="">
      <Navbar />
      <div className="">
        <div className="flex flex-col bg-gradient-to-r from-sky-300 via-sky-400 to-sky-300 rounded-xl   my-20 mx-5 md:mx-40 px-4 md:px-10 py-5 items-center text-gray-900 gap-8 shadow-2xl">
          <div className="flex items-center justify-between w-full">
            <h2 className="text-2xl md:text-2xl font-semibold ">Groups</h2>
